...
4. In MATLAB, open the 'detect.m' file inside the mhw_mhw1.0 folder download, and within the 'if' loop from lines 145-156, wrap each instance of 'ahead_date' in 'round()'
